    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    _a.sent();
                    return [2 /*return*/, "save a screenshot as ".concat(screenshotpath)];
                case 7:
                ...
                case 9:
                    _a.sent();
                    return [2 /*return*/, "The title of thhe page is ".concat(title)];
...
function runTest() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, performAction("https://www.myntra.com/", 'screenshot')];
                case 1:
                    screenshotResult = _a.sent();
                    console.log(screenshotResult);
                    return [4 /*yield*/, performAction("https://www.myntra.com/", 'title')];
                case 2:
                    titleResult = _a.sent();
